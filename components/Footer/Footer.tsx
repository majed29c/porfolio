        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-4 text-white/70 hover:text-white transition-colors">
              ...
              <a href="mailto:majedshmaitlu@email@example.com" className="text-sm">majedshmaitlu@gmail.com</a>
            </div>
            <div className="flex items-center space-x-4 text-white/70 hover:text-white transition-colors">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              <Link href="#about" className="block text-white/70 hover:text-white transition-colors text-sm">About</Link>
              <Link href="#projects" className="block text-white/70 hover:text-white transition-colors text-sm">Projects</Link>
              <Link href="#contact" className="block text-white/70 hover:text-white transition-colors text-sm">Contact</Link>
            </div>
          </div>
